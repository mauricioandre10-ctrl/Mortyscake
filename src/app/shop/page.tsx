...
export const metadata: Metadata = {
  ...
  description: 'Encuentra ingredientes de alta calidad, herramientas profesionales y utensilios para llevar tu repostería al siguiente nivel. Todo lo que necesitas para crear.',
  openGraph: {
